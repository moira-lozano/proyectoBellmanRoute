                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.sectionContent}>
                        <Text style={styles.sectionItem}>
                            ...
                            de la aplicación App BellRouteClient. Al utilizar la Aplicación, usted acepta
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.sectionContent}>
                        <View style={styles.sectionItem}>
                            ...
                            <Text style={styles.sectionItemDesc}>
                                Política de privacidad de App BellRouteClient En BellRoute solutions, desarrolladores de la
                        ...
                        <View style={styles.sectionItem}>
                            ...
                            <Text style={styles.sectionItemDesc}>
                                ...
                                de su dispositivo móvil cuando utilice la aplicación App BellRouteClient para ofrecerle servicios
